<template>
	<view class="picker-region" :style="{'cursor':disabled ? 'move' : 'default'}">
		<picker
			:disabled="disabled"
			mode="multiSelector"
			...
			@cancel="opend = false"
		>
			<view class="picker-region-uni-input" :style="{'color':disabled ? '#666' : '#333'}" :class="{ 'picker-region-placeholder': modelValue == '' }">
...
.picker-region-placeholder {
	width: 100%;
}
.picker-region-placeholder text{
	color: #666;
