<template>
	<view>
		<search :inputPlaceholder="inputPlaceholder" :inputHeight="inputHeight" :isFocus="isFocus" :theme="theme"
		 ...
		 @delhHistory="delhistory" @inputChange="inputchange" v-model="searchinput"></search>
