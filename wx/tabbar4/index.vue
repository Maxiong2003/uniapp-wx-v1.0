	...
	<view class="bgColor">
		<view class="person-wx" v-if="userInfo">
			<view class="person-wx-user">
				<image class="person-wx-avatar" @click="$fc.previewImagesolo(userInfo.portrait)" :src="userInfo.portrait"
				...
				<view class="person-wx-user-detail" @click="goPersonDetail">
					...
					<view class="person-wx-name">
						<text class="text">微信号：Max-Ethereal-1{{ userInfo.chatNo }}</text>
